...
func initialize(numberOfPlayers):
	...
	$Contents/PlayerNumber.text = "P"+str(character.playerNumber)
...
func update():
	...
	# Reset
	$Contents/NoBalloons.visible = false
	$Contents/Dead.visible = false
	for i in range(1,11):
	...
	# Update Balloon Counter
		...
		print("0 balloons")
		$Contents/NoBalloons.visible = true

func setBalloonCounterVisibility(visibility):
	$Contents/BalloonCounter.visible = visibility
	for i in range(1,6):
